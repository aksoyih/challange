...
--
-- Table structure for table `callback_urls`
--
...
CREATE TABLE `callback_urls` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `event` enum('started','renewed','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `devices` (
  ...
  `operating_system` enum('android','ios') COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Indexes for table `callback_urls`
--
ALTER TABLE `callback_urls`
  ADD PRIMARY KEY (`id`),
  ADD KEY `callback_urls_app_id_index` (`app_id`);
...
ALTER TABLE `devices`
  ...
  ADD KEY `devices_app_id_index` (`app_id`);
...
ALTER TABLE `subscriptions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `subscriptions_app_id_index` (`app_id`),
  ADD KEY `subscriptions_device_id_index` (`device_id`);
...
--
-- AUTO_INCREMENT for table `callback_urls`
--
ALTER TABLE `callback_urls`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `callback_urls`
--
ALTER TABLE `callback_urls`
  ADD CONSTRAINT `callback_urls_app_id_foreign` FOREIGN KEY (`app_id`) REFERENCES `apps` (`id`);
